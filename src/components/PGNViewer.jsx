      ...
      { !game ? <Loader /> : 
        ...
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1em'}}>
          <h3 style={{display: 'inline'}}>Moves</h3>
          {
            ...
            <button onClick={() => copyToClipboard(game.pgn())}><i className='fa fa-clone'></i></button>
          }
        </div>
        ...
        </div>
        {
          ...
          <div className='pgn-buttons'>
            <button onClick={() => move(0, true)}><i className='fa fa-angles-left'></i></button>
            <button onClick={() => move(selectedMove - 1, true)}><i className='fa fa-angle-left'></i></button>
            <button onClick={() => move(selectedMove + 1, true)}><i className='fa fa-angle-right'></i></button>
            <button onClick={() => move(moves.length - 1, true)}><i className='fa fa-angles-right'></i></button>
          </div>
        }
        </>
      }
