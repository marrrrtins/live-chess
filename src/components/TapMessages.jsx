...
export default function TapMessages({ gameId }) {
  ...
  let messagesArr = ["Hello", "Still there?", "I'm thinking...", "Good Move", "Oops", "Good Game", "Noooo", "I resign", "Gotta go", "lol", "heyyy", "there's a glitch"]
  ...
  return (
    <div style={{padding: '1em'}}>
      <audio src='/sound/new-alert.mp3' ref={alertRef} />
      {
